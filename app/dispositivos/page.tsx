      ...
      <div className={`${sidebarOpen ? 'w-64' : 'w-0'} bg-gray-800 text-white transition-all duration-300 overflow-hidden`}>
        <div className="p-4">
          ...
          <div className="mt-8 pt-4 border-t border-gray-700">
            ...
            <nav className="space-y-2">
              <button onClick={() => router.push('/importar-proveedores')} className="w-full text-left px-4 py-2 rounded hover:bg-gray-700 transition-colors">📥 Importar Proveedores</button>
            </nav>
          </div>
          <div className="mt-8 pt-4 border-t border-gray-700">
